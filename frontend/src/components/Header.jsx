        ...
        <>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    background: 'linear-gradient(to right, #B5006B, transparent)',
                    zIndex: 2, pointerEvents: 'none',
                }} />
                {/* Right fade */}
                <div style={{
                    position: 'absolute', right: 0, top: 0, bottom: 0, width: 80,
                    background: 'linear-gradient(to left, #FF4D6D, transparent)',
                    zIndex: 2, pointerEvents: 'none',
                }} />
            ...
            <header style={{
                ...
                boxShadow: scrolled
                    ? '0 4px 28px rgba(252,39,121,0.10)'
                    : '0 1px 0 #F0E0EA',
                ...
                <div style={{
                    ...
                    <Link to="/" style={{ textDecoration: 'none', flexShrink: 0 }}>
                        <span style={{
                            ...
                            color: '#FC2779', letterSpacing: '-0.01em', lineHeight: 1,
                        }}>
                    ...
                    {/* Search */}
                    <form onSubmit={searchHandler} className="hide-mobile"
                        style={{ flex: 1, maxWidth: 560, position: 'relative' }}>
                        <svg style={{
                            position: 'absolute', left: 18, top: '50%',
                            transform: 'translateY(-50%)',
                            color: '#FC2779', pointerEvents: 'none',
                    ...
                    <div style={{
                        ...
                        gap: 6, marginLeft: 'auto', flexShrink: 0,
                    }}>
                        ...
                        <Link to="/recommend" className="hide-mobile" style={{
                            ...
                            boxShadow: '0 4px 18px rgba(252,39,121,0.32)',
                            transition: 'all .2s',
                        }}
                            onMouseEnter={e => {
                                e.currentTarget.style.transform = 'translateY(-2px)';
                                e.currentTarget.style.boxShadow = '0 8px 28px rgba(252,39,121,0.42)';
                            }}
                            onMouseLeave={e => {
                                e.currentTarget.style.transform = 'none';
                                e.currentTarget.style.boxShadow = '0 4px 18px rgba(252,39,121,0.32)';
                            }}
                        >
                            ✨ AI Skin Match
                        </Link>
                            ...
                            {userInfo ? (
                                <>
                                    <button onClick={() => setUserMenuOpen(v => !v)} style={{
                                        ...
                                        color: '#2D2D2D', fontSize: 16, fontWeight: 600,
                                    ...
                                    >
                                        <span style={{
                                            ...
                                            border: '2.5px solid #FC2779', flexShrink: 0,
                                        }}>
                                            {userInfo.name?.[0]?.toUpperCase()}
                                        </span>
                                        <span className="hide-mobile" style={{ fontSize: 15 }}>
                                    ...
                                    {userMenuOpen && (
                                        <div style={{
                                            ...
                                            <button onClick={logoutHandler} style={{
                                                ...
                                                padding: '12px 16px', fontSize: 16, color: '#E53E3E',
                                                background: 'none', border: 'none', cursor: 'pointer',
                        ...
                        <Link to="/cart" className="gp-action-btn" style={{
                            ...
                            gap: 8, textDecoration: 'none', color: '#2D2D2D',
                        ...
                        >
                            {mobileOpen
                                ...
                                : <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>
                            }
                        </button>
                    </div>
                </div>
                ...
                <nav className="full-nav" style={{
                    ...
                    <Link
                        ...
                        style={{
                            ...
                            borderBottom: location.pathname === '/recommend'
                                ? '3px solid #FC2779' : '3px solid transparent',
                            background: location.pathname === '/recommend'
                                ? 'linear-gradient(to bottom, #fff, #FFF5FA)' : 'transparent',
                            transition: 'all .18s',
                        }}
                    >
                        ✨ AI Skin Analysis
                ...
                {mobileOpen && (
                    <div style={{
                        ...
                        boxShadow: '0 8px 24px rgba(252,39,121,0.08)',
                    }}>
                        <form onSubmit={searchHandler} style={{ marginBottom: 14, position: 'relative' }}>
                            <svg style={{
                            ...
                            <input type="text" placeholder="Search products..."
                                ...
                                style={{
                                    ...
                                    outline: 'none', background: '#FFF5FA',
                                }}
                            />
                        </form>
                        <nav style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                            {NAV_LINKS.map(link => {
                                ...
                                return (
                                    <Link key={link.to} to={link.to} style={{
                                        ...
                                        color: active ? '#FC2779' : '#2D2D2D',
                                        borderRadius: 12, textDecoration: 'none',
                                        background: active ? '#FFF5FA' : 'transparent',
                            ...
                            <Link to="/recommend" style={{
                                padding: '13px 16px', fontSize: 22, fontWeight: 800,
                                color: '#FC2779', borderRadius: 12, textDecoration: 'none',
                                background: '#FFF5FA',
