    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 360, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 11, color: "#9CA3AF", marginTop: 6 }}>Step 2 of 3</p>
        </div>
      </div>
      {/* HEADER END */}
      ...
      <div style={{
        ...
        <div style={{
          ...
          {cameraOn && (
            <div style={{ flex:1, position:"relative", borderRadius:20, overflow:"hidden", background:"#0D0D0D", minHeight:340 }}>
              ...
              <div style={{
                ...
                <span style={{ color:"#fff",fontSize:12,fontWeight:600 }}>{faceLabel}</span>
                {faceDetected && (
                  <div style={{ display:"flex",alignItems:"center",gap:8 }}>
                    ...
                    <span style={{ color:faceColor,fontSize:11,fontWeight:700 }}>{faceScore}%</span>
                  </div>
                )}
              </div>
          ...
          {preview && !cameraOn && (
            <div style={{ position:"relative",borderRadius:20,overflow:"hidden",flex:1,minHeight:260,animation:"fadeIn 0.3s ease" }}>
              ...
              <div style={{
                ...
                <span style={{ color:"#fff",fontWeight:700,fontSize:13 }}>Face validated, ready to analyze!</span>
                <button
                  onClick={() => { setPreview(null); setImageFile(null); setRejectMsg(""); }}
                  style={{ marginLeft:"auto",background:"rgba(255,255,255,0.2)",border:"none",color:"#fff",borderRadius:99,padding:"6px 14px",fontSize:11,fontWeight:600,cursor:"pointer" }}
                >
                  Retake
                </button>
              </div>
          ...
          {!cameraOn && !preview && (
            ...
            >
              ...
              <p style={{ fontSize:14,fontWeight:700,color:"#D91A66" }}>Drag & drop your selfie here</p>
              <p style={{ fontSize:12,color:"#9CA3AF" }}>or click to browse · JPG, PNG · max 10MB</p>
            </div>
          )}
          ...
          {rejectMsg && (
            <div style={{
              ...
              padding:"14px 18px", color:"#DC2626", fontSize:12, fontWeight:500,
        ...
        <div style={{
          ...
          <h2 style={{ fontSize:18,fontWeight:900,marginBottom:16,color:"#1a1a1a" }}>
          ...
          {TIPS.map((tip, i) => (
            <div key={i} className="tip-row" style={{
              ...
              <div style={{
                ...
                display:"flex", alignItems:"center", justifyContent:"center",
                fontSize:17, border:"1.5px solid #F9A8D4",
              }}>
                {tip.icon}
              </div>
              <div>
                <p style={{ fontSize:14,fontWeight:800,color:"#1a1a1a",marginBottom:5 }}>{tip.title}</p>
                <p style={{ fontSize:13,color:"#6B7280",lineHeight:1.6 }}>{tip.desc}</p>
              </div>
            </div>
          ))}
