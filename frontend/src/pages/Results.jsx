  ...
  return (
    <div style={{ display: "flex", gap: 18, padding: "18px 0", borderBottom: "1px solid #F9FAFB" }}>
      ...
      <div>
        ...
        {sub && <p style={{ margin: "5px 0 0", fontSize: 11, color: "#9CA3AF" }}>{sub}</p>}
      </div>
    </div>
  );
}
...
function ProductCard({ product, onAddToCart, added }) {
  return (
    ...
    >
      ...
      {/* Info */}
      <p style={{ margin: "0 0 6px", fontSize: 13, fontWeight: 800, color: "#1F2937", lineHeight: 1.35 }}>
        {product.name}
      </p>
      {product.brand && (
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16, marginTop: "auto" }}>
        <span style={{ fontWeight: 900, fontSize: 14, color: "#1C1C1E" }}>₹{product.price}</span>
        {product.rating && (
          <span style={{
    ...
    <div style={{ minHeight: "100vh", background: "#FDFCFD", paddingBottom: 80, fontFamily: "inherit" }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 380, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 11, color: "#9CA3AF", marginTop: 6 }}>Step 3 of 3</p>
        </div>
      </div>
      ...
      <div style={{ maxWidth: "96%", margin: "0 auto", paddingTop: 36 }}>
        ...
        <div style={{ ...cardStyle, display: "flex", gap: 40, alignItems: "center", marginBottom: 30, overflow: "hidden" }}>
          <div style={{ flex: 1 }}>
            <h2 style={{ fontSize: 22, fontWeight: 900, marginBottom: 22, color: "#111827", letterSpacing: "-.02em" }}>
              Your Skin Analysis
            </h2>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: 12, flexWrap: "wrap" }}>
              <span style={{ fontSize: 13, fontWeight: 700, color: "#374151" }}>Detected Concerns:</span>
          ...
          <div style={{ width: "36%", height: 200, borderRadius: 20, overflow: "hidden", flexShrink: 0, position: "relative" }}>
            ...
            <div style={{
              ...
              <p style={{ margin: 0, fontSize: 11, fontWeight: 800, color: "#FC2779" }}>✦ AI Analysis Complete</p>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.15fr 2fr", gap: 28 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            <h3 style={{ fontSize: 18, fontWeight: 900, color: "#374151", margin: 0 }}>Your Routine</h3>

            <div style={cardStyle}>
              <h4 style={{ margin: "0 0 20px", fontSize: 15, fontWeight: 900, color: "#FC2779" }}>
                Morning Routine ☀️
              </h4>
            ...
            <div style={cardStyle}>
              <h4 style={{ margin: "0 0 20px", fontSize: 15, fontWeight: 900, color: "#7C3AED" }}>
                Night Routine 🌙
              </h4>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            <div style={{ ...cardStyle, border: "2px solid #FCE7F3", background: "#FFFBFD" }}>
              <div style={{ display: "flex", gap: 22, alignItems: "flex-start" }}>
                ...
                <div style={{ flex: 1 }}>
                  <h4 style={{ margin: "0 0 18px", fontSize: 15, fontWeight: 900, color: "#111827" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <h3 style={{ fontSize: 17, fontWeight: 900, color: "#374151", margin: 0 }}>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              display: "inline-flex", alignItems: "center", gap: 10,
              background: "#fff", color: "#6B7280", fontWeight: 700, fontSize: 12,
