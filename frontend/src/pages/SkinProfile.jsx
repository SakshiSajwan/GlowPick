    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 360, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 16, color: "#9CA3AF", marginTop: 6 }}>Step 1 of 3</p>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: "grid", gridTemplateColumns: "1fr 1fr" }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 20, color: "#6B7280", marginBottom: 28 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <span style={{ fontSize: 24, fontWeight: 900, color: "#1F2937" }}>Skin Concerns</span>
              <span style={{ color: "#F87171", fontSize: 24 }}>*</span>
            </div>
            {concerns.length > 0 && (
              <span className="selected-pop" style={{
                fontSize: 16, fontWeight: 800, color: "#FC2779",
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <span style={{ fontSize: 24, fontWeight: 900, color: "#1F2937" }}>Allergies & Sensitivities</span>
              <span style={{ fontSize: 16, color: "#9CA3AF", fontWeight: 500 }}>(optional)</span>
            </div>
            {allergies.length > 0 && (
              <span className="selected-pop" style={{
              ...
              return (
                ...
                >
                  ...
                  <div style={{
                    ...
                    {sel && <span style={{ color: "#fff", fontSize: 16, fontWeight: 900 }}>✓</span>}
                  </div>
                </button>
              );
            })}
          ...
          <div style={{
            ...
            <span style={{ fontSize: 27, flexShrink: 0 }}>🔒</span>
            <div>
              <p style={{ fontSize: 18, fontWeight: 800, color: "#1F2937", marginBottom: 3 }}>
      ...
      <div style={{
        ...
        {!canProceed && concerns.length === 0 && (
          <p style={{ textAlign: "center", fontSize: 16, color: "#9CA3AF", marginTop: 10 }}>
